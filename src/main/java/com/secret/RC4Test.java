...
public class RC4Test {
	...
	public static void main(String[] args) throws Exception {
		String aKey="abcdeeab";
		String str="测试aatest123";
		
		String encodeStr=encry_RC4_string(str,aKey);
		String decodeStr=decry_RC4_string(encodeStr,aKey);
